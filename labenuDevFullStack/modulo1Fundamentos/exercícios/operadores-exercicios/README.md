...
-  [x] Clone sua **PRÓPRIA** versão do repositório
   <details>
      <summary>Esqueceu como se faz?</summary>
...
-  [x] Crie uma nova branch: git checkout -b `<turma-nome-sobrenome-a008>`.
   <details>
...
-  [x] item 1 - Operadores **aritméticos**
-  [x] item 2 - Operadores **relacionais**
-  [x] item 3 - Operadores **lógicos**
